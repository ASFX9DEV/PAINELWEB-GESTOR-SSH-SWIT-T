...
sleep 5
cd /bin || exit
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/checkuser.py > /dev/null 2>&1
