...
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/gestorssh18.zip > /dev/null 2>&1
...
function inst_db { 
cd || exit
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
function tst_bkp {
cd /bin || exit
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/userteste.sh
wget https://github.com/ASFX9DEV/PAINELWEBV20/raw/main/gestorssh/autobackup.sh
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@ASFx9DEV\033[0m"
echo ""
